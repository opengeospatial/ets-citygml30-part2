package org.opengis.cite.citygml30part2.level1;
...
import org.opengis.cite.citygml30part2.ErrorMessageKeys;
import org.opengis.cite.citygml30part2.SuiteAttribute;
...
public class Capability1Tests extends CommonFixture {
     ...
     * {@link org.opengis.cite.citygml30part2.SuiteAttribute#TEST_SUBJECT} should
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/citygml30part2/rnc/atom.rnc");
