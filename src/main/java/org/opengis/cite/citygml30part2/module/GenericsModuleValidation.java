...
public class GenericsModuleValidation extends CommonFixture {
	...
	/**
	 * <p>
	 * Verify that instance documents using the Generics XML elements listed in <a href=
	 * "https://docs.ogc.org/is/21-006r2/21-006r2.html#generics-xml-elements">Table 18</a>
	 * validate against the XML schema specified in <a href=
	 * "http://schemas.opengis.net/citygml/generics/3.0/generics.xsd">generics.xsd</a>.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * For each Generics space element verify that if the space element is bounded by
	 ...
	 * "https://docs.ogc.org/is/21-006r2/21-006r2.html#generics-boundaries-table">Table
	 * 19</a> that is supported for the specific space element. If no surface element is
	...
	public void VerifyGenericsBoundaries() {
		String[] allowedSpace = { "gen:GenericLogicalSpace", "gen:GenericOccupiedSpace", "gen:GenericUnoccupiedSpace" };
