...
public class PointCloudModuleValidation extends CommonFixture {
	...
	/**
	 * <p>
	 * Verify that instance documents using the PointCloud XML elements listed in <a href=
	 * "https://docs.ogc.org/is/21-006r2/21-006r2.html#pointcloud-xml-elements">Table
	 * 21</a> validate against the XML schema specified in <a href=
	 * "http://schemas.opengis.net/citygml/pointcloud/3.0/pointCloud.xsd">pointCloud.xsd</a>.
	 * </p>
	 */
