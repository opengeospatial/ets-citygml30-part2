...
public class TunnelModuleValidation extends CommonFixture {
	 ...
	 * <a href="https://docs.ogc.org/is/21-006r2/21-006r2.html#tunnel-xml-elements">Table
	 * 25</a> validate against the XML schema specified in
	 * <a href="http://schemas.opengis.net/citygml/tunnel/3.0/tunnel.xsd">/tunnel.xsd</a>.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * For each Tunnel space element, verify that if the space element is bounded by
	 ...
	 * "https://docs.ogc.org/is/21-006r2/21-006r2.html#tunnel-boundaries-table">Table
	 * 26</a> that is supported for the specific space element. If no surface element is
	...
	public void VerifyTunnelBoundaries() {
		String[] allowedSpace = { "tun:AbstractTunnel", "tun:HollowSpace", "tun:Tunnel",
				"tun:TunnelConstructiveElement", "tun:TunnelFurniture", "tun:TunnelInstallation", "tun:TunnelPart" };
